                  ...
                  <div class="row align-items-center">
                    <div class="col-auto">
                      ...
                      <a href="#" class="avatar rounded-circle">
                        <img alt="Image placeholder" src="<?php echo base_url('assets/uploads/customers/'. $customer->profile_picture); ?>">
                      </a>
                    </div>
                    <div class="col ml--2">
                      <h4 class="mb-0">
                  ...
                  <div class="row align-items-center">
                    <div class="col-auto">
                      ...
                      <a href="<?php echo site_url('admin/payments/users/'. $payment->user_id); ?>" class="avatar rounded-circle">
                        <img alt="Image placeholder" src="<?php echo base_url('assets/uploads/customers/'. $payment->profile_picture); ?>">
                      </a>
                    </div>
                    <div class="col">
