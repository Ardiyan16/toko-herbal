        ...
        <form action="<?php echo site_url('admin/contacts/reply'); ?>" method="POST">
          ...
          <div class="card-body">
            <!-- <div class="form-group">
                       <label class="form-control-label" for="email">Pesan Balasan</label>
            ...
            <div class="form-group">
              <label class="form-control-label" for="msg">Pesan Balasan</label>
              <input type="hidden" name="id_users" value="<?= $contact->parent_id ?>">
