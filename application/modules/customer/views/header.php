...
<head>
  ...
  <!-- DataTables -->
  <link rel="stylesheet" href="<?= get_theme_uri('plugins/datatables-bs4/css/dataTables.bootstrap4.min.css', 'adminlte') ?>">
  <link rel="stylesheet" href="<?= get_theme_uri('plugins/datatables-responsive/css/responsive.bootstrap4.min.css', 'adminlte') ?>">
  <link rel="stylesheet" href="<?= get_theme_uri('plugins/datatables-buttons/css/buttons.bootstrap4.min.css', 'adminlte') ?>">

  <link rel="icon" href="<?php echo base_url('assets/uploads/sites/Admin.png'); ?>" type="image/icon">
      ...
      <div class="sidebar">
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
              <a href="<?php echo site_url('customer/message'); ?>" class="nav-link">
