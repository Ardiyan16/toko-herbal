        ...
        <div class="row">
            ...
            <div class="col-lg-6 product-details pl-md-5 ftco-animate">
                ...
                <div class="rating d-flex">
                    ...
                    <!-- <p class="text-left">
                              <a href="#" class="mr-2" style="color: #000;"><?php echo $terlaris ?> <span style="color: #bbb;">Sold</span></a>
                          </p> -->
                </div>
                <p class="price">
...
<section class="ftco-section ftco-degree-bg">
    <div class="container">
        <div class="row">
            <div class="pt-5 mt-5">
                <h3 class="mb-5">Review Terbaru</h3>
                <ul class="comment-list">
                    <?php foreach ($reviews as $rev) { ?>
                        <li class="comment">
                            <div class="vcard bio">
                                <?php if ($rev->profile_picture == null) { ?>
                                    <img src="<?= base_url() ?>assets/uploads/customers/defaults.png" alt="Image placeholder">
                                <?php } else { ?>
                                    <img src="<?= base_url('assets/uploads/customers/' . $rev->profile_picture) ?>" alt="Image placeholder">
                                <?php } ?>
                            </div>
                            <div class="comment-body">
                                <h3><?= $rev->name ?></h3>
                                <div class="meta"><?= $rev->review_date ?></div>
                                <p><?= $rev->review_text ?></p>
