...
?>
<div class="hero-wrap hero-bread" sstyle="background-image: url(<?php echo base_url('assets/themes/vegefoods/images/Halamanweb.jpeg');?>);">
    <div class="container">
    </div>
  </div>
              ...
              <div class="col-md-12 ftco-animate">
                  <div class="cart-list">
                      <table class="table">
                          ...
                          <tbody>
                              <?php $qty = $this->session->userdata('order_quantity');
                            ...
                            <tr class="text-center cart-<?php echo $item['rowid']; ?>">
                              ...
                              <td class="quantity">
                                  <div class="input-group mb-3">
                                   <input type="text" id="order_quantity" name="quantity[<?php echo $item['rowid']; ?>]" class="quantity form-control input-number" value="<?php echo $item['qty']; ?>" min="1" max="100">
                                </div>
                            </td>
